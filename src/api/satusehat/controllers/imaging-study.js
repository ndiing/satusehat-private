...
const Service = require("../services/imaging-study");
const { merge, unflatten } = require("../../../lib/helper");

class ImagingStudy extends Controller {
    static services = {};
    ...
    static async init(req, res, next) {
        try {
            ...
            if (!ImagingStudy.services[_id]) {
                ImagingStudy.services[_id] = new Service({ storage: res.locals.storage });
            }

            res.locals.service = ImagingStudy.services[_id];
